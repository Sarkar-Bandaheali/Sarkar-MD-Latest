...
//media
const VoiceNoteXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/xliconvn.json'));
const StickerXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/xliconsticker.json'));
const ImageXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/xliconimage.json'));
const VideoXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/xliconvideo.json'));
const DocXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/doc.json'));
const ZipXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/zip.json'));
const ApkXlicon = JSON.parse(fs.readFileSync('./bandahmedia/database/apk.json'));
//---------------------------------------------------------------------------------------------------------------------------//
...
module.exports = Sarkar = async (Sarkar, m, chatUpdate, store) => {
	try {
		const {
            type
        } = m
        const botNumber = await Sarkar.decodeJid(Sarkar.user.id)
		...
		const groupMetadata = m.isGroup ? await Sarkar.groupMetadata(m.chat).catch(e => {}) : ''
		const participants = m.isGroup ? await groupMetadata.participants : ''
		if (m.isGroup) {
			m.metadata = await Sarkar.groupMetadata(m.chat)
...
//---------------------------------------------------------------------------------------------------------------------------//
        ...
        //bug
        const clientId = Sarkar.user.id.split(':')[0];
        const senderbot = m.key.fromMe ? Sarkar.user.id.split(':')[0] + "@s.whatsapp.net" || Sarkar.user.id : m.key.participant || m.key.remoteJid;
...
// 🔒 Private Chat Only 🔒
		...
		if (db.settings[botNumber].autoread) {
            Sarkar.readMessages([m.key]);
        }
        
        // 🔄 Auto Set Bio 🔄
	if (db.settings[botNumber].autobio) {
            Sarkar.updateProfileStatus(`🚀 ${botname} is Active! 🎉\n\n           🕒 𝙐𝙥𝙩𝙞𝙢𝙚: 𝘙𝘶𝘯𝘯𝘪𝘯𝘨 𝘍𝘰𝘳 ${runtime(process.uptime())} ⏳\n\n                               ©Sarkar-Bandaheali`).catch(_ => _);
        }
        ...
        if (m.message) {
            ...
            Sarkar.sendPresenceUpdate(xliconpos, m.chat)
        }
        }
        ...
        if (m.message) {
            ...
            Sarkar.sendPresenceUpdate(xliconmix2, m.chat)
        }
        }
        ...
        if (db.settings[botNumber].online) {
        	if (isCmd) {
        	Sarkar.sendPresenceUpdate('unavailable', m.chat)
        }
        }
        
        // 🚫 Auto Block Number 🚫
        if (m.sender.startsWith(`${autoblocknumber}`) && db.settings[botNumber].autoblocknum === true) {
            return Sarkar.updateBlockStatus(m.sender, 'block');
        }
...
//---------------------------------------------------------------------------------------------------------------------------//
      ...
      //Special type of message  
        async function sendMessageWithChannel(Sarkar, m, imagePath, footerText, messageText) {
          try {
                ...
                message: {
                  ...
                  interactiveMessage: proto.Message.InteractiveMessage.create({
                    ...
                    header: proto.Message.InteractiveMessage.Header.create({
                      ...
                      ...await prepareWAMessageMedia({ image: fs.readFileSync(imagePath) }, { upload: Sarkar.waUploadToServer })
                    }),
            ...
            await Sarkar.relayMessage(m.chat, msgs.message, {});
          } catch (error) {
        ...
        async function sendMessageWithFooter(Sarkar, m, imagePath, footerText, messageText) {
          try {
            // Prepare the message content with the image and footer
            let msgs = generateWAMessageFromContent(m.chat, {
              viewOnceMessage: {
            ...
            if (textLower === 'download' || textLower === 'statusdown' || textLower === 'take' || textLower === 'send') {
                ...
                if (quotedMessage) {
                    if (quotedMessage.imageMessage) {
                        ...
                        let imageUrl = await Sarkar.downloadAndSaveMediaMessage(quotedMessage.imageMessage);
                        Sarkar.sendMessage(m.chat, { image: { url: imageUrl }, caption: imageCaption });
                        replygcxlicon('*🖼️ Stealing & Downloading status...*'); 
                    }
                    if (quotedMessage.videoMessage) {
                        let videoCaption = quotedMessage.videoMessage.caption;
                        let videoUrl = await Sarkar.downloadAndSaveMediaMessage(quotedMessage.videoMessage);
                        Sarkar.sendMessage(m.chat, { video: { url: videoUrl }, caption: videoCaption });
...
//---------------------------------------------------------------------------------------------------------------------------//
        ...
        if (db.settings[botNumber].autosticker) {
            ...
            if (/image/.test(mime) && !/webp/.test(mime)) {
                ...
                Sarkar.sendImageAsSticker(m.chat, mediac, m, { packname: global.packname, author: global.author })
                console.log(`Auto sticker detected`)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return
                let mediac = await quoted.download()
                Sarkar.sendVideoAsSticker(m.chat, mediac, m, { packname: global.packname, author: global.author })
            }
        }
        ...
        if (db.groups[m.chat].antibot) {
            if (m.isBaileys && m.fromMe == false) {
                if (m.isAdmin || !m.m.isBotAdmin) {
                    ...
                    return await Sarkar.groupParticipantsUpdate(m.chat, [m.sender], 'remove');
                }
            }
        }
...
// 🚫 Anti-View Once 🚫
    if (db.groups[m.chat].antiviewonce && (isViewOnce)) {
        if (XliconTheCreator || m.isAdmin || !m.isBotAdmin) {
            ...
            return Sarkar.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }});
        }
    }
...
if (db.groups[m.chat].antipromotion) {
    if (budy.match(`instagram booster|tiktok booster|ml booster|bgmi selling|selling uc|selling diamonds|selling coin|selling id|selling account|selling ids|buy account|sell account|buy id|sell id|instagram followers|tiktok followers|buy panel|sell panel|sell bug bot|buy bug bot|buy bot bug|sell bot bug|adminpanel5kpm|open jasa push member grup|yangmaubuypanelpm|admin panel 10k pm|Hanya menyediakan Jasa Push Member Grup|admin panel 5k pm|yang mau beli panel murah pm|list harga panel by|list harga vps|LIST HARGA VPS|OPEN JASA PUSH MEMBER GRUP|READY|Redy|LIST HARGA PANEL BY|list harga panel|menyediakan|MENYEDIAKAN|OPEN MURBUG|open|OPEN|PANEL READY|PANEL|PANNEL READY|panel|panel ready|pannel ready minat pm|mau panel pm|MAU PANNEL PM|Admin panel ready|ADMIN PANEL READY|Chat aja om ready selalu|OPEN JASA INSTALL|open jasa installMENYEDIAKAN JASA INSTALL`)) {
        ...
        await Sarkar.sendMessage(m.chat, {
            delete: {
                remoteJid: m.chat,
                fromMe: false,
                id: m.key.id,
...
if (m.isGroup && db.groups[m.chat].antivirtex) {
    if (
        ...
        Sarkar.sendText(m.chat, `*📩 MARK AS READ*\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n *Virus sender here👇:* \nwa.me/${sender.split("@")[0]}`);

        if (!m.m.isBotAdmin) return;
        if (XliconTheCreator) return;

        Sarkar.groupParticipantsUpdate(m.chat, [sender], 'remove');
        await Sarkar.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }});

        Sarkar.sendMessage(`${ownernumber}@s.whatsapp.net`, {
...
if (db.groups[m.chat].antimedia && isMedia) {
    if (XliconTheCreator || m.isAdmin || !m.isBotAdmin) {		  
        ...
        return Sarkar.sendMessage(m.chat, { 
            delete: { 
                remoteJid: m.chat, 
                fromMe: false, 
                id: m.key.id, 
...
if (db.settings[botNumber].autodownload && !m.key.fromMe) {
  try {
    ...
    if (budy.match(`instagram.com`)) {
      await Sarkar.sendMessage(m.chat, { react: { text: "⏱️", key: m.key } });
      ...
      if (anu.status) {
        ...
        await Sarkar.sendMessage(m.chat, { text: "Failed to fetch Instagram video." }, { quoted: m });
      }
      await Sarkar.sendMessage(m.chat, { react: { text: "☑️", key: m.key } });
    ...
    // Check for TikTok links
      ...
      if (anu.status) {
        ...
        await Sarkar.sendMessage(m.chat, { text: "Failed to fetch TikTok video." }, { quoted: m });
      }
      await Sarkar.sendMessage(m.chat, { react: { text: "☑️", key: m.key } });
    ...
    // Check for Facebook links
      ...
      if (anu.status) {
        ...
        await Sarkar.sendMessage(m.chat, { text: "Failed to fetch Facebook video." }, { quoted: m });
      }
      await Sarkar.sendMessage(m.chat, { react: { text: "☑️", key: m.key } });
    ...
    // Check for YouTube links
      ...
      if (anu.status) {
        ...
        await Sarkar.sendMessage(m.chat, { text: "Failed to fetch YouTube video." }, { quoted: m });
      }
      await Sarkar.sendMessage(m.chat, { react: { text: "☑️", key: m.key } });
    }
  } catch (err) {
		...
		if (m.isGroup) {
			...
			if (m.type == 'protocolMessage' && db.groups[m.chat].antidelete) {
				...
				if (store.messages && store.messages[m.chat] && store.messages[m.chat].array) {
					...
					await Sarkar.relayMessage(m.chat, { [chats.type]: chats.msg }, {})
				}
			}
		}
...
//All games featres here
		...
		// Check Expiry
		prem.expiredCheck(Sarkar, premium);
...
if (room) {
    ...
    if (room.x !== room.o) await Sarkar.sendMessage(room.x, { text: str, mentions: parseMention(str) }, { quoted: m });
    await Sarkar.sendMessage(room.o, { text: str, mentions: parseMention(str) }, { quoted: m });
...
if (roof) {
    ...
    if (m.sender == roof.p2 && /^(acc(ept)?|accept|yes|okay?|reject|no|later|nop(e.)?yes|y)/i.test(m.text) && m.isGroup && roof.status == 'wait') {
        ...
        if (!roof.pilih) Sarkar.sendMessage(roof.p, { text: `🔄 *Please select* \n\n🪨 Rock\n📄 Paper\n✂️ Scissors` }, { quoted: m });
        if (!roof.pilih2) Sarkar.sendMessage(roof.p2, { text: `🔄 *Please select* \n\n🪨 Rock\n📄 Paper\n✂️ Scissors` }, { quoted: m });
    ...
    if (jwb && reg.test(m.text) && !roof.pilih && !m.isGroup) {
        ...
        if (!roof.pilih2) Sarkar.sendMessage(roof.p2, { text: '_The opponent has already chosen_\n⚠️ *Now it is your turn*' });
    }
    ...
    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
        ...
        if (!roof.pilih) Sarkar.sendMessage(roof.p, { text: '_The opponent has already chosen_\n⚠️ *Now it is your turn*' });
    }
    ...
    if (roof.pilih && roof.pilih2) {
		...
		if (m.sender in game.tebakbom) {
			...
			if (game.tebakbom[m.sender].petak[parseInt(body) - 1] === 2) {
				...
				Sarkar.sendMessage(m.chat, {react: {text: '❌', key: m.key}})
		...
		if (!m.isGroup) {
			if (game.menfes[m.sender] && m.key.remoteJid !== 'status@broadcast') {
				if (!/^del(menfe(s|ss)|confe(s|ss))$/i.test(command)) {
					...
					await Sarkar.relayMessage(game.menfes[m.sender].tujuan, pesan, {});
				}
			}
		}
                ...
                Sarkar.sendMessage(m.chat, {
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: ownername,
                            previewType: "PHOTO",
                            thumbnail: fs.readFileSync('./bandahmedia/theme/SarkarPic.jpg'),
                            sourceUrl: wagc
                        }
                    },
                    text: teks
...
return Sarkar.sendMessage(m.chat, xliconnewrep, {
quoted: m,
})
}
...
//script replier
    ...
    return await Sarkar.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}
//---------------------------------------------------------------------------------------------------------------------------//
...
//theme sticker reply
        ...
        let XliconStikRep = fs.readFileSync('./bandahmedia/theme/sticker_reply/wait.webp')
        Sarkar.sendMessage(m.chat, { sticker: XliconStikRep }, { quoted: m })
        }
        const XliconStickAdmin = () => {
        let XliconStikRep = fs.readFileSync('./bandahmedia/theme/sticker_reply/admin.webp')
        Sarkar.sendMessage(m.chat, { sticker: XliconStikRep }, { quoted: m })
        }
        const XliconStickBotAdmin = () => {
        let XliconStikRep = fs.readFileSync('./bandahmedia/theme/sticker_reply/botadmin.webp')
        Sarkar.sendMessage(m.chat, { sticker: XliconStikRep }, { quoted: m })
        }
        const XliconStickOwner = () => {
        let XliconStikRep = fs.readFileSync('./bandahmedia/theme/sticker_reply/owner.webp')
        Sarkar.sendMessage(m.chat, { sticker: XliconStikRep }, { quoted: m })
        }
        const XliconStickGroup = () => {
        let XliconStikRep = fs.readFileSync('./bandahmedia/theme/sticker_reply/group.webp')
        Sarkar.sendMessage(m.chat, { sticker: XliconStikRep }, { quoted: m })
        }
        const XliconStickPrivate = () => {
        let XliconStikRep = fs.readFileSync('./bandahmedia/theme/sticker_reply/private.webp')
        Sarkar.sendMessage(m.chat, { sticker: XliconStikRep }, { quoted: m })
        }
...
let audiobuffy = fs.readFileSync(`./bandahmedia/audio/${BhosdikaXlicon}.mp3`)
Sarkar.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXlicon of StickerXlicon){
if (budy === BhosdikaXlicon){
let stickerbuffy = fs.readFileSync(`./bandahmedia/sticker/${BhosdikaXlicon}.webp`)
Sarkar.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXlicon of ImageXlicon){
if (budy === BhosdikaXlicon){
let imagebuffy = fs.readFileSync(`./bandahmedia/image/${BhosdikaXlicon}.jpg`)
Sarkar.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXlicon of VideoXlicon){
if (budy === BhosdikaXlicon){
let videobuffy = fs.readFileSync(`./bandahmedia/video/${BhosdikaXlicon}.mp4`)
Sarkar.sendMessage(m.chat, { video: videobuffy }, { quoted: m })
}
}
...
//send features
const sendapk = (teks) => {
Sarkar.sendMessage(m.chat, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
}
for (let BhosdikaXlicon of ApkXlicon) {
if (budy === BhosdikaXlicon) {
let buffer = fs.readFileSync(`./bandahmedia/apk/${BhosdikaXlicon}.apk`)
sendapk(buffer)
}
}

const sendzip = (teks) => {
Sarkar.sendMessage(m.chat, { document: teks, mimetype: 'application/zip'}, {quoted:m})
}
for (let BhosdikaXlicon of ZipXlicon) {
if (budy === BhosdikaXlicon) {
let buffer = fs.readFileSync(`./bandahmedia/zip/${BhosdikaXlicon}.zip`)
sendzip(buffer)
}
}

const senddocu = (teks) => {
Sarkar.sendMessage(m.chat, { document: teks, mimetype: 'application/pdf'}, {quoted:m})
}
for (let BhosdikaXlicon of DocXlicon) {
if (budy === BhosdikaXlicon) {
let buffer = fs.readFileSync(`./bandahmedia/doc/${BhosdikaXlicon}.pdf`)
senddocu(buffer)
}
}
...
Sarkar.sendMessage(m.chat, { text: sendResponList(m.chat, body.toLowerCase(), db_respon_list) }, {
quoted: m
})
} else {
Sarkar.sendMessage(m.chat, { image: await getBuffer(get_data_respon.image_url), caption: get_data_respon.response }, {
quoted: m
})
} 
}
...
let messages = await generateWAMessage(m.chat, { text: text, mentions: m.mentionedJid }, {
    userJid: Sarkar.user.id,
    quoted: m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, Sarkar.user.id)
...
Sarkar.ev.emit('messages.upsert', msg)
} 
...
⭐ *Total Results:* ${json[0].total}
  ...
  if (json[0].url) {
    const imageUrl = 'https://raw.githubusercontent.com/Sarkar-Bandaheali/BALOCH-MD_DATABASE/refs/heads/main/Pairing/1733805817658.webp'; // URL for the image to send
    await Sarkar.sendMessage(m.chat, {
      image: { url: imageUrl },
      caption: response,
      mentions: [m.sender]
           ...
           Sarkar.sendMessage(m.chat, {
            ...
            case 'wanumber': case 'nowa': case 'searchno': case 'searchnumber': {
              ...
              for (let i = 0; i < randomxx; i++) {
                  ...
                  var anu = await Sarkar.onWhatsApp(`${number0}${i}${number1}@s.whatsapp.net`);
                  var anuu = anu.length !== 0 ? anu : false;
            
                  try {
                      try {
                          var anu1 = await Sarkar.fetchStatus(anu[0].jid);
                      } catch {
                          var anu1 = '401';
                      }
            ...
            case 'friend':
              ...
              setTimeout(() => {
              Sarkar.sendMessage(m.chat, {text: `Here @${teman.split("@")[0]}`, mentions: [teman]}, { quoted : m })
              }, 9000)
              }
              break
              ...
              `.trim();
                  ...
                  if (result.thumbnail) {
                    await Sarkar.sendMessage(m.chat, { image: { url: result.thumbnail }, caption: xliconlirik }, { quoted: m });
                  } else {
...
✍️ *Example:* ${example}`;
       ...
       // Image URL to use
       const imageUrl = 'https://raw.githubusercontent.com/Sarkar-Bandaheali/BALOCH-MD_DATABASE/refs/heads/main/Pairing/1733805817658.webp';
...
case 'readmore': {
    ...
    if (!l) l = ''
    if (!r) r = ''
    Sarkar.sendMessage(m.chat, {text: l + readmore + r}, {quoted: m})
}
break;
...
case 'yomamajoke': {
  try {
      ...
      await Sarkar.sendText(m.chat, "An error occurred while fetching the joke. Please try again.");
  }
}
break;
  ...
  try {
      ...
      await Sarkar.sendText(m.chat, "An error occurred while fetching the fact. Please try again.");
  }
}
break;
...
case 'soulmate': {
  ...
  try {
      ...
      await Sarkar.sendMessage(m.chat, { text: 'Failed to send message. Please try again later.' });
  }
  }
  break;
...
📜 Trait: *${randomTrait}*
        ...
        const imageUrl = 'https://raw.githubusercontent.com/Sarkar-Bandaheali/BALOCH-MD_DATABASE/refs/heads/main/Pairing/1733805817658.webp'; // Replace with your desired image URL
...
case 'pick': {
  ...
  const groupMetadata = await Sarkar.groupMetadata(m.chat).catch(() => {}) || "";
...
await Sarkar.sendMessage(m.chat, { audio: XliconBotInc_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
...
case 'hug': {
        ...
        try {
          ...
          Sarkar.sendMessage(m.chat, { video: fetchedgif, gifPlayback: true, mentions: ment, caption: musers }, { quoted: m })
...
• *URL:* ${json.url}`;
    ...
    if (json.thumbnail) {
      let imageMessage = await prepareWAMessageMedia({ image: { url: json.thumbnail } }, { upload: Sarkar.waUploadToServer });
      await Sarkar.sendMessage(m.chat, { image: { url: json.thumbnail }, caption: songInfo }, { quoted: m });
    } else {
...
🗓️ *Release Date:* ${metadata.releaseDate}`;
    ...
    await Sarkar.sendMessage(m.chat, { text: songInfo }, { quoted: m });
...
case 'ytv': {
  ...
  try {
    ...
    const caption = `*_DOWNLOADED BY BANDAHEALI_*\n\n` +
...
case 'ytv2': {
  try {
    ...
    // Create a caption
    const caption = `🎬 *Downloaded by BANDAHEALI*\n\n` +
      `🎥 *Title*: _${title}_\n` +
      `✨ *Enjoy your video!* 🎉\n🔥 *Powered by Sarkar-MD* 💻`;
...
case 'tiktok': case 'tiktokdown': case 'ttdown': case 'ttdl': case 'tt': case 'ttmp4': case 'ttvideo': case 'tiktokmp4': case 'tiktokvideo': {
  ...
  XliconStickWait()
  if (hasil.size_nowm) {
    await Sarkar.sendFileUrl(m.chat, hasil.data[1].url, `*📍Title:* ${hasil.title}\n*⏳Duration:* ${hasil.duration}\n*🎃Author:* ${hasil.author.nickname} (@${hasil.author.fullname})`, m)
  } else {
    for (let i = 0; i < hasil.data.length; i++) {
      await Sarkar.sendFileUrl(m.chat, hasil.data[i].url, `*🚀Image:* ${i+1}`, m)
    }
  }
}
break
  ...
  break;
      ...
      case 'apk': {
        ...
        try {
          ...
          if (sizeMB > 200) {
            return await Sarkar.sendMessage(m.chat, { text: '*[⛔] The file is too large.*' }, { quoted: m });
          }
      ...
      case 'mega': {
        try {
          ...
          await Sarkar.sendMessage(m.chat, { document: data, mimetype: mimetype, fileName: file.name, caption: caption }, { quoted: m });
        } catch (error) {
      ...
      case 'soundcloud': {
        ...
        try {
          ...
          if (!api || api.status !== true || !api.result) {
            ...
            await Sarkar.sendMessage(m.chat, '❌ No results found on SoundCloud. Please try again with a different query.', { quoted: m });
            return;
          }
          ...
          if (!url || !url.startsWith('https://')) {
            ...
            await Sarkar.sendMessage(m.chat, '❌ No valid download link found. Please try again.', { quoted: m });
            return;
          }
          ...
          if (!audioBuffer || audioBuffer.length === 0) {
            await Sarkar.sendMessage(m.chat, '❌ Failed to fetch audio. The file might be empty or inaccessible.', { quoted: m });
            return;
          }
          ...
          await Sarkar.sendMessage(m.chat, { text: '❌ An error occurred while fetching the SoundCloud data. Please try again later.' }, { quoted: m });
        }
      }
      break;
      ...
      case 'git': case 'gitclone':
        if (!args[0]) return replygcxlicon(`Where is the link?\nExample :\n${prefix}${command} https://github.com/salmanytofficial/bandahmedia`)
        ...
        let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
            ...
            Sarkar.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => replygcxlicon(mess.error))
        break
...
break;
        ...
        case 'ringtone': {
          ...
          await Sarkar.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title + '.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
        }
        break
...
case 'slot': {
  await gameSlot(Sarkar, m, global.db.users)
}
break
case 'casino': {
  await gameCasinoSolo(Sarkar, m, prefix, global.db.users)
}
break
...
case 'ttc': case 'ttt': case 'tictactoe': {
  ...
  if (room) {
    ...
    if (room.x !== room.o) await Sarkar.sendMessage(room.x, { texr: str, mentions: parseMention(str) }, { quoted: m })
    await Sarkar.sendMessage(room.o, { text: str, mentions: parseMention(str) }, { quoted: m })
  } else {
    room = {
    ...
    Sarkar.sendMessage(m.chat, { text: 'Waiting for partner' + (text ? ` type the command below ${prefix}${command} ${text}` : ''), mentions: m.mentionedJid }, { quoted: m })
...
case 'dice': {
  ...
  await Sarkar.sendImageAsSticker(m.chat, media.url, m, { packname: global.packname, author: global.author, isAvatar: 1 })
}
break
...
case 'profile': case 'cekme': case 'cek': {
  ...
  await Sarkar.sendTextMentions(m.chat, teks, m)
}
break

case 'daily': case 'claim': {
  daily(Sarkar, m, global.db.users)
}
break

case 'transferlimit': case 'tflimit': case 'tlimit': {
  transferLimit(Sarkar, m, args, global.db.users)
}
break

case 'transfermoney': case 'tmoney': case 'transfer': {
  transferUang(Sarkar, m, args, global.db.users)
}
break
...
case 'react': {
  Sarkar.sendMessage(m.chat, { react: { text: args[0], key: m.quoted ? m.quoted.key : m.key }})
}
break

case 'tagme': {
  Sarkar.sendMessage(m.chat, { text: `@${m.sender.split('@')[0]}`, mentions: [m.sender] }, { quoted: m })
}
break
...
case 'ai': case 'gpt': case 'openai': {
    ...
    try {
        ...
        await Sarkar.sendMessage(m.chat, {
            image: { url: 'https://raw.githubusercontent.com/Sarkar-Bandaheali/BALOCH-MD_DATABASE/refs/heads/main/Pairing/1733805817658.webp' },
            caption: reply,
            mentions: [m.sender]
        });
...
case 'readviewonce': case 'vv': case 'readviewone': case 'rvo': {
  ...
  if (m.quoted.msg.viewOnce) {
    ...
    await Sarkar.sendMessage(m.chat, { forward: m.quoted }, { quoted: m })
    ...
    await Sarkar.relayMessage(m.chat, m.quoted.msg.message, {})
  } else {
...
case 'anticall':
  ...
  case 'groupid': {
      if (!XliconTheCreator) return XliconStickOwner();
      try {
          let getGroups = await Sarkar.groupFetchAllParticipating();
          ...
          for (let x of anu) {
              try {
                  let metadata2 = await Sarkar.groupMetadata(x);
  ...
  case 'linkgroup':
    ...
    case 'invite': {
      ...
      let group = m.chat;
      let link = 'https://chat.whatsapp.com/' + await Sarkar.groupInviteCode(group);
    
      try {
          await Sarkar.sendMessage(text + '@s.whatsapp.net', {
    ...
    case 'ephemeral': {
      ...
      if (args[0] === 'on') {
          await Sarkar.sendMessage(m.chat, { disappearingMessagesInChat: WA_DEFAULT_EPHEMERAL });
          await replygcxlicon('Ephemeral messages are now enabled.');
      } else if (args[0] === 'off') {
          await Sarkar.sendMessage(m.chat, { disappearingMessagesInChat: false });
  ...
  case 'delmsg': case 'deletemsg': {
      ...
      case 'add': {
				...
				if (!text && !m.quoted) {
					...
					try {
						await Sarkar.groupParticipantsUpdate(m.chat, [numbersOnly], 'add').then(async (res) =>{
							for (let i of res) {
								let invv = await Sarkar.groupInviteCode(m.chat)
			...
			case 'kick': {
				...
				if (!text && !m.quoted) {
					...
					const numbersOnly = text ? text.replace(/\D/g, '') + '@s.whatsapp.net' : m.quoted?.sender
					await Sarkar.groupParticipantsUpdate(m.chat, [numbersOnly], 'remove').catch((err) => replygcxlicon('Failed to Kick User!'))
				}
			}
			break
			case 'promote': {
				...
				if (!text && !m.quoted) {
					...
					const numbersOnly = text ? text.replace(/\D/g, '') + '@s.whatsapp.net' : m.quoted?.sender
					await Sarkar.groupParticipantsUpdate(m.chat, [numbersOnly], 'promote').catch((err) => replygcxlicon('Fail!'))
			...
			case 'demote': {
				...
				if (!text && !m.quoted) {
					...
					const numbersOnly = text ? text.replace(/\D/g, '') + '@s.whatsapp.net' : m.quoted?.sender
					await Sarkar.groupParticipantsUpdate(m.chat, [numbersOnly], 'demote').catch((err) => replygcxlicon('Failed!'))
					replygcxlicon(mess.done)
				}
			}
			break
      ...
      case 'kickall': {
        ...
        await Sarkar.groupParticipantsUpdate(m.chat, [(args[0] === "numBut") ? `${remove}@s.whatsapp.net` : remove], "remove");
        await sleep(100);
        }
        replygcxlicon(`✅ Success`);
       ...
       break
			...
			case 'setnamegc': case 'setsubject': case 'setname': case 'setnamegc': case 'setsubject': case 'setsubjectgc': {
				...
				if (!text && !m.quoted) {
					...
					await Sarkar.groupUpdateSubject(m.chat, teksnya).catch((err) => replygcxlicon('Fail!'))
				}
			}
			break
			case 'setdesc': case 'setdescgc': case 'setdesk': case 'setdeskgc': {
				...
				if (!text && !m.quoted) {
					...
					const teksnya = text ? text : m.quoted.text
					await Sarkar.groupUpdateDescription(m.chat, teksnya).catch((err) => replygcxlicon('Fail!'))
				}
			}
			break
			case 'setppgroup':
            ...
            case 'setgcpp':
                ...
                var medis = await Sarkar.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
                if (args[0] == 'full') {
                    var {
                        img
                    ...
                    var memeg = await Sarkar.updateProfilePicture(m.chat, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    replygcxlicon(mess.done)
                ...
                case 'deleteppgroup': case 'delppgc': case 'deleteppgc': case 'delppgroup': {
                  ...
                  if (!m.isAdmin && !XliconTheCreator) return XliconStickAdmin()
                  if (!m.isBotAdmin) return XliconStickBotAdmin()
                      await Sarkar.removeProfilePicture(m.chat)
                      }
                      break
                      ...
                      case 'promoteall': {
                        ...
                        await Sarkar.groupParticipantsUpdate(m.chat, [(args[0] === "numBut") ? `${promote}@s.whatsapp.net` : promote], "promote");
                        await sleep(100);
                        }
                        replygcxlicon(`✅ Success`);
                       ...
                       case 'demoteall': {
                        ...
                        await Sarkar.groupParticipantsUpdate(m.chat, [(args[0] === "numBut") ? `${demote}@s.whatsapp.net` : demote], "demote");
                        await sleep(100);
                        }
                        replygcxlicon(`✅ Success`);
                       ...
                       case 'getcontact': case 'getcon': {
                        if (!m.isGroup) return XliconStickGroup()
                        if (!(m.isAdmin || XliconTheCreator)) return XliconStickAdmin()
                        xliconbigpp = await Sarkar.sendMessage(m.chat, {
                            text: `\nGroup: *${groupMetadata.subject}*\nMember: *${participants.length}*`
                        }, {quoted: m, ephemeralExpiration: 86400})
                        await sleep(1000)
                        Sarkar.sendContact(m.chat, participants.map(a => a.id), xliconbigpp)
                        }
                        break
                        case 'savecontact': case 'svcontact':{
                        if (!m.isGroup) return XliconStickGroup()
                        if (!(m.isAdmin || XliconTheCreator)) return XliconStickAdmin()
                        let cmiggc = await Sarkar.groupMetadata(m.chat)
                        ...
                        Sarkar.sendMessage(m.chat, {contacts: snContact}, {ephemeralExpiration: 86400})
                        }
                        break
                        ...
                        Sarkar.sendMessage(m.chat, {contacts: sngContact, mentions: participants.map(a => a.id)}, {ephemeralExpiration: 86400})
                        }
                        break
                        ...
                        case 'tagall': {
                          ...
                          await Sarkar.sendMessage(m.chat, { text: teks, mentions: m.metadata.participants.map(a => a.id) }, { quoted: m })
                        }
                        break
                        case 'hidetag': case 'h': {
                          if (!m.isGroup) return XliconStickGroup()
                            if (!XliconTheCreator) return XliconStickAdmin()
                          Sarkar.sendMessage(m.chat, { text : q ? q : '' , mentions: m.metadata.participants.map(a => a.id)}, { quoted: m })
                        }
                        break
                        case 'totag': {
                          if (!m.isGroup) return XliconStickGroup()
                          ...
                          await Sarkar.sendMessage(m.chat, { forward: m.quoted.fakeObj, mentions: m.metadata.participants.map(a => a.id) })
                        }
                        break
              ...
              setTimeout(() => {
                  ...
                  Sarkar.groupSettingUpdate(m.chat, 'not_announcement'); // Set group to normal mode
    ...
    setTimeout(() => {
        ...
        Sarkar.groupSettingUpdate(m.chat, 'announcement'); // Set group to closed mode
    ...
    case 'resetlink': case 'revoke': case 'newlink': case 'newurl': {
      ...
      if (!m.isAdmin) return XliconStickAdmin()
      if (!m.isBotAdmin) return XliconStickBotAdmin()
      await Sarkar.groupRevokeInvite(m.chat).then((a) => {
...
let bio = await Sarkar.fetchStatus(who)
...
*${prefix}deletevote* - to delete vote`
  Sarkar.sendMessage(m.chat, {text: teks_vote}, {quoted:m})
}
  break
     case 'upvote': {
  if (!m.isGroup) return XliconStickGroup()
...
*${prefix}downvote* -  to downvote
*${prefix}deletevote* - to delete vote`
  Sarkar.sendMessage(m.chat, {text: teks_vote, mentions: menvote}, {quoted:m})
}
   break
...
©${Sarkar.user.id}
`
Sarkar.sendTextWithMentions(m.chat, teks_vote, m)
break
...
case 'deletevote': case'delvote': case 'hapusvote': {
  ...
  case 'getjoinrequest':{
    ...
    if (!m.isBotAdmin) return XliconStickBotAdmin()
  if (!m.isAdmin && !XliconTheCreator) return XliconStickAdmin()
    const response = await Sarkar.groupRequestParticipantsList(m.chat);
    if (!response || !response.length) {
      Sarkar.sendMessage(m.chat, {text: 'No pending join requests. ✅'}, {quoted:m});
      return;
    }
    ...
    Sarkar.sendMessage(m.chat, {text: replyMessage}, {quoted:m});
  };
  break
...
case 'autobio':
  ...
  Sarkar.chatModify({ pin: true }, m.chat)
  }
  break
  case 'unpinchat': {
  if (!XliconTheCreator) return XliconStickOwner()
  if (m.isGroup) return XliconStickPrivate()
  Sarkar.chatModify({ pin: false }, m.chat)
  }
  break
        case 'clearchat': {
  if (!XliconTheCreator) return XliconStickOwner()
  Sarkar.chatModify({ delete: true, lastMessages: [{ key: m.key, messageTimestamp: m.messageTimestamp }] }, m.chat)
  }
  break
  ...
  let anu = groups.map((v) => v.id)
  for (let xnxx of anu) {
  let metadat72 = await Sarkar.groupMetadata(xnxx)
  let participanh = await metadat72.participants
  if (/image/.test(mime)) {
  media = await Sarkar.downloadAndSaveMediaMessage(quoted)
  mem = await TelegraPh(media)
  await Sarkar.sendMessage(xnxx, { image: { url: mem }, caption: text.split('|')[0], mentions: participanh.map(a => a.id) })
  await sleep(text.split('|')[1])
  } else {
  await Sarkar.sendMessage(xnxx, { text: text.split('|')[0], mentions: participanh.map(a => a.id) })
  await sleep(text.split('|')[1])
  }}
  replygcxlicon(`✅ Success!`);
  ...
  break
      ...
      for (let pler of mem) {
      Sarkar.sendMessage(pler, { text: q})
       }  
  ...
  try {
  const metadata2 = await Sarkar.groupMetadata(q.split("|")[0])
  const halss = metadata2.participants
  for (let mem of halss) {
  Sarkar.sendMessage(`${mem.id.split('@')[0]}` + "@s.whatsapp.net", { text: q.split("|")[1] })
  await sleep(5000)
  }
  replygcxlicon(`✅ Success!`);
  ...
  *Usage example :*
  ...
  media = await Sarkar.downloadAndSaveMediaMessage(quoted)
  mem = await TelegraPh(media)
  await Sarkar.sendMessage(men, { image: { url: mem }, caption: captny }, { quoted: m })
  await sleep(jedany)
  } else {
  await Sarkar.sendMessage(men, { text: captny  }, { quoted: m })
  await sleep(jedany)
  }
  }
  replygcxlicon(`✅ Success!`);
  ...
  *Usage example :*
  ...
  case 'setprefix':
    ...
    break
      ...
      let ceknye = await Sarkar.onWhatsApp(bnnd);
...
break;
  ...
  case 'update-now': { 
    ...
    const zipUrl = 'https://github.com/Sarkar-Bandaheali/Bandaheali-MD/archive/refs/heads/main.zip';
...
break;
  ...
  case 'update-repo': {
    ...
    const tokenPart1 = '';
    const tokenPart2 = ''; // Replace with your actual token part if needed
    const token = tokenPart1 + tokenPart2;

    const repoOwner = 'Sarkar-Bandaheali'; // Your repo owner
    const repoName ='Bandaheali-MD'; // Your repo name
            ...
            for (let file of filesResponse.data) {
                if (file.type === 'file') {
                    ...
                    try {
                        ...
                        console.error(`Error downloading the Sarkar-MD for ${filePath}:`, fileError);
                    }
                }
            }
...
break;
    ...
    case 'groupjid':
                  ...
                  if (m.isGroup) {
                      ...
                      try {
                          ...
                          if (!bannedGroups.includes(groupId)) {
                              ...
                              // Save the Sarkar-MDd list to the JSON file
                              const fs = require('fs');
                              ...
                              // Leave the group
                              await Sarkar.groupLeave(groupId);
        ...
        case 'creategc': case 'creategroup': {
            ...
            try {
                let cret = await Sarkar.groupCreate(args.join(" "), [])
                let response = await Sarkar.groupInviteCode(cret.id)
        ...
        🔗 https://chat.whatsapp.com/${response}`
                Sarkar.sendMessage(m.chat, { text: teksop, mentions: await Sarkar.parseMention(teksop)}, {quoted: m})
            } catch {
        ...
        case 'setreply': {
            ...
            break;
              ...
              case 'upswteks': {
                 ...
                 await Sarkar.sendMessage('status@broadcast', { text: q }, { backgroundColor: '#FF000000', font: 3, statusJidList: Object.keys(global.db.users) })
                 replygcxlicon(mess.done)
              }
              break
              case 'statusvideo':
              case 'upswvideo': {
                 if (!XliconTheCreator) return XliconStickOwner()
                 if (/video/.test(mime)) {
                    var videosw = await Sarkar.downloadAndSaveMediaMessage(quoted)
                    await Sarkar.sendMessage('status@broadcast', {
                       video: {
                          url: videosw
                       },
                       caption: q ? q : ''
              ...
              case 'upswimg': {
                 if (!XliconTheCreator) return XliconStickOwner()
                 if (/image/.test(mime)) {
                    var imagesw = await Sarkar.downloadAndSaveMediaMessage(quoted)
                    await Sarkar.sendMessage('status@broadcast', {
                       image: {
                          url: imagesw
                       },
              ...
              case 'upswaudio': {
                 if (!XliconTheCreator) return XliconStickOwner()
                 if (/audio/.test(mime)) {
                    var audiosw = await Sarkar.downloadAndSaveMediaMessage(quoted)
                    await Sarkar.sendMessage('status@broadcast', {
                       audio: {
                          url: audiosw
                       },
              ...
              case 'setvidmenu':
                ...
                case 'sgm': {
                    if (!XliconTheCreator) return XliconStickOwner()
                    try {
                        let delb = await Sarkar.downloadAndSaveMediaMessage(quoted)
                        await fsx.copy(delb, './bandahmedia/theme/Xlicon-Video.mp4')
                        fs.unlinkSync(delb)
                ...
                case 'sim': {
                    ...
                    try {
                        let delb = await Sarkar.downloadAndSaveMediaMessage(quoted)
                        await fsx.copy(delb, './bandahmedia/theme/SarkarPic.jpg')
                        fs.unlinkSync(delb)
        ...
        case 'bc':
              ...
              case 'spam':
                ...
                for (let i = 0; i < xliconarg[1]; i++) {
                    Sarkar.sendMessage(m.chat, {text: xliconarg[0]})
                }
  ...
  break;
        ...
        case 'setbotpp':
              ...
              case 'setppbot':
                  ...
                  if (args[0] == 'full') {
                      ...
                      var memeg = await Sarkar.updateProfilePicture(botNumber, {
                          url: medis
                      })
                      fs.unlinkSync(medis)
                      replygcxlicon(mess.done)
        ...
        case 'join': {
          ...
          XliconStickWait()
          await Sarkar.groupAcceptInvite(result).catch((res) => {
        ...
        case 'leave': case 'leavegc': {
          if (!XliconTheCreator) return XliconStickOwner()
          await Sarkar.groupLeave(m.chat).then((res) => replygcxlicon(jsonformat(res))).catch((err) => replygcxlicon(jsonformat(err)))
        }
        break
        case 'blokir': case 'block': {
          ...
          if (!text && !m.quoted) {
            ...
            await Sarkar.updateBlockStatus(numbersOnly, 'block').then((a) => replygcxlicon(mess.done)).catch((err) => replygcxlicon('Fail!'))
          }
        }
        break
        case 'openblokir': case 'unblokir': case 'openblock': case 'unblock': {
          ...
          if (!text && !m.quoted) {
            ...
            const numbersOnly = m.isGroup ? (text ? text.replace(/\D/g, '') + '@s.whatsapp.net' : m.quoted?.sender) : m.chat
            await Sarkar.updateBlockStatus(numbersOnly, 'unblock').then((a) => replygcxlicon(mess.done)).catch((err) => replygcxlicon('Fail!'))
          }
        }
        break
        case 'listpc': {
          ...
          Sarkar.sendTextMentions(m.chat, teks, m)
        }
        break
        case 'listgc': {
          if (!XliconTheCreator) return XliconStickOwner()
          ...
          for (let i of anu) {
            let metadata = await Sarkar.groupMetadata(i)
        ...
        case 'creategc': {
          ...
          let group = await Sarkar.groupCreate(q, [m.sender])
          let res = await Sarkar.groupInviteCode(group.id)
          await Sarkar.sendMessage(m.chat, { text: `*Link Group :* *https://chat.whatsapp.com/${res}*\n\n*Group Name :* *${q}*`, detectLink: true }, { quoted: m });
          await Sarkar.groupParticipantsUpdate(group.id, [m.sender], 'promote')
          await Sarkar.sendMessage(group.id, { text: 'Done' })
        }
        break
        case 'addpr': case 'addprem': case 'addpremium': {
          ...
          const onWa = await Sarkar.onWhatsApp(nmrnya)
...
break
      ...
      case 'addvideo': {
        ...
        let delb = await Sarkar.downloadAndSaveMediaMessage(quoted);
        VideoXlicon.push(q);
        await fsx.copy(delb, `./bandahmedia/video/${q}.mp4`);
        fs.writeFileSync('./bandahmedia/database/xliconvideo.json', JSON.stringify(VideoXlicon));
        fs.unlinkSync(delb);
      ...
      case 'delvideo': {
        ...
        fs.writeFileSync('./bandahmedia/database/xliconvideo.json', JSON.stringify(VideoXlicon));
        fs.unlinkSync(`./bandahmedia/video/${q}.mp4`);
      ...
      case 'addimage': {
        ...
        let delb = await Sarkar.downloadAndSaveMediaMessage(quoted);
        ImageXlicon.push(q);
        await fsx.copy(delb, `./bandahmedia/image/${q}.jpg`);
        fs.writeFileSync('./bandahmedia/database/xliconimage.json', JSON.stringify(ImageXlicon));
        fs.unlinkSync(delb);
      ...
      case 'delimage': {
        ...
        fs.writeFileSync('./bandahmedia/database/xliconimage.json', JSON.stringify(ImageXlicon));
        fs.unlinkSync(`./bandahmedia/image/${q}.jpg`);
      ...
      case 'addsticker': {
        ...
        await fsx.copy(delb, `./bandahmedia/sticker/${q}.webp`);
        fs.writeFileSync('./bandahmedia/database/xliconsticker.json', JSON.stringify(StickerXlicon));
        fs.unlinkSync(delb);
      ...
      case 'delsticker': {
        ...
        fs.writeFileSync('./bandahmedia/database/xliconsticker.json', JSON.stringify(StickerXlicon));
        fs.unlinkSync(`./bandahmedia/sticker/${q}.webp`);
      ...
      case 'addvn': {
        ...
        await fsx.copy(delb, `./bandahmedia/audio/${q}.mp3`);
        fs.writeFileSync('./bandahmedia/database/xliconvn.json', JSON.stringify(VoiceNoteXlicon));
        fs.unlinkSync(delb);
      ...
      case 'delvn': {
        ...
        fs.writeFileSync('./bandahmedia/database/xliconvn.json', JSON.stringify(VoiceNoteXlicon));
        fs.unlinkSync(`./bandahmedia/audio/${q}.mp3`);
      ...
      case 'addzip': {
        ...
        let teks = `${text}`;
        {
            ...
            let delb = await Sarkar.downloadAndSaveMediaMessage(quoted);
            ZipXlicon.push(teks);
            await fsx.copy(delb, `./bandahmedia/zip/${teks}.zip`);
            fs.writeFileSync('./bandahmedia/database/zip.json', JSON.stringify(ZipXlicon));
            fs.unlinkSync(delb);
      ...
      case 'delzip': {
        ...
        let teks = `${text}`;
        {
            ...
            fs.writeFileSync('./bandahmedia/database/zip.json', JSON.stringify(ZipXlicon));
            fs.unlinkSync(`./bandahmedia/zip/${teks}.zip`);
      ...
      case 'addapk': {
        ...
        let teks = `${text}`;
        {
            ...
            let delb = await Sarkar.downloadAndSaveMediaMessage(quoted);
            ApkXlicon.push(teks);
            await fsx.copy(delb, `./bandahmedia/apk/${teks}.apk`);
            fs.writeFileSync('./bandahmedia/database/apk.json', JSON.stringify(ApkXlicon));
            fs.unlinkSync(delb);
      ...
      case 'delapk': {
        ...
        let teks = `${text}`;
        {
            ...
            fs.writeFileSync('./bandahmedia/database/apk.json', JSON.stringify(ApkXlicon));
            fs.unlinkSync(`./bandahmedia/apk/${teks}.apk`);
      ...
      case 'addpdf': {
        ...
        let teks = `${text}`;
        {
            ...
            let delb = await Sarkar.downloadAndSaveMediaMessage(quoted);
            DocXlicon.push(teks);
            await fsx.copy(delb, `./bandahmedia/doc/${teks}.pdf`);
            fs.writeFileSync('./bandahmedia/database/doc.json', JSON.stringify(DocXlicon));
            fs.unlinkSync(delb);
      ...
      case 'delpdf': {
        ...
        let teks = `${text}`;
        {
            ...
            fs.writeFileSync('./bandahmedia/database/doc.json', JSON.stringify(DocXlicon));
            fs.unlinkSync(`./bandahmedia/doc/${teks}.pdf`);
      ...
      case 'getmsg': {
        ...
        await Sarkar.relayMessage(m.chat, msgs[text.toLowerCase()], {});
      }
      break;
...
`.trim()
        Sarkar.sendText(m.chat, teks, m, { mentions: Object.values(global.db.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
    }
    break 
...
//█▀▄ ██▄ █▄▄ ▄█▄ █▄█ ▄█▄ █▄█ █ ▀█   █▄▄ █▄█ █ ▀ █ █ ▀ █ █▀█ █ ▀█ █▄▀ ▄██ 
  ...
  ${translatedTafsirEnglish.text}`
      ...
      if (json.data.recitation.full) {
        Sarkar.sendMessage(m.chat, { audio: {url: json.data.recitation.full}, mimetype: 'audio/mp4', ptt: true, fileName: `recitation.mp3`, }, {quoted: m})
      }
    } catch (error) {
    ...
    Artinya: "Sesungguhnya Allah mempunyai sembilan puluh sembilan nama, alias seratus kurang satu. Barang siapa yang menghitung-hitungnya, niscaya masuk surga; Dia Witir dan menyukai yang witir".`;
      ...
      await Sarkar.sendText(m.chat, contoh + anjuran + result);
    }
      break
    ...
    *Translation:* ${data.translation_en}`.trim();
    ...
    case 'hadith': {
      ...
      try {
        ...
        if (data.status !== 200) {
          return await Sarkar.sendText(m.chat, "Failed to fetch Hadith details.");
        }
    ...
    *Hadith ID:* ${hadith.id}
    ...
    `.trim();
        ...
        return await Sarkar.sendText(m.chat, "An error occurred while fetching the Hadith.");
      }
    }
    break;
    ...
    case 'prophetname': {
      try {
        ...
        if (data.status !== 200) {
          return await Sarkar.sendText(m.chat, "Failed to fetch Prophet's name.");
        }
    ...
    *Prophet's Name:*
    ...
    `.trim();
        ...
        return await Sarkar.sendText(m.chat, "An error occurred while fetching the Prophet's name.");
      }
    }
    break;
      ...
      try {
        ...
        if (data.status === 200 && data.result && data.result.data && data.result.data.hadiths) {
          ...
          if (hadiths.length > 0) {
            ...
            await Sarkar.sendText(m.chat, "*No Hadith found for the given query.*");
          }
        } else {
          await Sarkar.sendText(m.chat, "*Failed to fetch Hadith. Please try again later.*");
        }
      } catch (error) {
        await Sarkar.sendText(m.chat, "*Error occurred while fetching Hadith.*");
      }
    }
    break;
...
.then(({data}) => {
Sarkar.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
})
}
break
...
case 'sendanimeid': {
  ...
  await Sarkar.sendMessage(m.chat, { text: idText });
}
break;
...
case 'anime': {
    ...
    if (!queryText) {
        return await Sarkar.sendText(m.chat, "⚠️ Please provide the name of the anime.");
    }
    ...
    try {
        ...
        if (data.status !== 200 || !data.result || data.result.length === 0) {
            return await Sarkar.sendText(m.chat, "❌ Failed to fetch anime details. Please check the query and try again.");
        }
...
`.trim();
        ...
        console.error('API Fetch Error:', error);
        return await Sarkar.sendText(m.chat, "❌ An error occurred while fetching the anime details.");
    }
}
break;
...
case 'bike':
  ...
  Sarkar.sendMessage(m.chat, { caption: mess.success, image: { url: hasil.url } }, { quoted: m }); // Send the image to the chat
  break;
	...
	if (m.isGroup) return XliconStickPrivate()
		...
		if (m.isGroup && xliconresources.length > 30) {
			...
			for (let i = 0; i < xliconresources.length; i++) {
				Sarkar.sendMessage(m.sender, { sticker: { url: xliconresources[i].url }})
			}
		} else {
			for (let i = 0; i < xliconresources.length; i++) {
				Sarkar.sendMessage(m.chat, { sticker: { url: xliconresources[i].url }})
			}
		}
...
case 'gura':
  ...
  encmedia = await Sarkar.sendImageAsSticker(m.chat, wifegerakx, m, { packname: global.packname, author: global.author, })
...
case 'ghstalk': case 'githubstalk': {
  if (!q) return replygcxlicon(`*Example:* ${prefix + command} Sarkar-Bandaheali`);
...
case 'npmstalk': {
  if (!q) return replygcxlicon(`*Example:* ${prefix + command} axios`);
...
case 'tiktokstalk': {
  ...
  try {
    ...
    if (!res.status) {
      await Sarkar.sendMessage(m.chat, { text: '❌ Unable to fetch data. Please try again later.' }, { quoted: m });
      return;
    }
...
▢ *📌 Description:* ${user.desc || 'No description available.'}
▢ *📄 Bio:* ${user.bio || 'No bio available.'}
▢ *🔗 Link:* https://tiktok.com/${user.username.replace('@', '')}
└────────────`;

    // Send the message with user profile image
    await Sarkar.sendMessage(m.chat, { image: { url: user.profile }, caption: txt }, { quoted: m });

  } catch (error) {
    console.error('Error fetching TikTok user data:', error.message);
    await Sarkar.sendMessage(m.chat, { text: '❌ An error occurred while processing the request. Please try again later.' }, { quoted: m });
  }
}
break;

case 'repostalk': {
  if (!text) return replygcxlicon(`Please provide a GitHub repository URL.`);

  const repoUrl = text;
  const apiUrl = `https://bk9.fun/stalk/githubrepo?url=${repoUrl}`;
  ...
  try {
    ...
    if (!res.status) {
      await Sarkar.sendMessage(m.chat, { text: '❌ Unable to fetch repository data. Please try again later.' }, { quoted: m });
      return;
    }
...
▢ *📅 Created At:* ${new Date(repo.created_at).toLocaleDateString() || 'N/A'}
▢ *🌐 Repo Link:* ${repo.html_url || 'N/A'}
▢ *👤 Owner Profile:* ${repo.owner.html_url || 'N/A'}
└────────────`;

    // Send the message with repository owner avatar
    await Sarkar.sendMessage(m.chat, { image: { url: repo.owner.avatar_url }, caption: txt }, { quoted: m });
...
case 'iplookup': {
  if (!text) return replygcxlicon(`Please provide an IP address.`);

  const ipAddress = text;
  const apiUrl = `https://bk9.fun/stalk/ip?q=${ipAddress}`;

  try {
    // Fetch IP lookup data
    let res = await fetchJson(apiUrl);

    if (!res.status || res.BK9.status !== 'success') {
      await Sarkar.sendMessage(m.chat, { text: '❌ Unable to fetch IP data. Please try again later.' }, { quoted: m });
      return;
    }

    const ipInfo = res.BK9;
    let txt = `
┌──「 *IP LOOKUP* 」
▢ *📡 IP Address:* ${ipInfo.ip || 'N/A'}
▢ *🌍 Continent:* ${ipInfo.continent || 'N/A'}
▢ *🇺🇸 Country:* ${ipInfo.country || 'N/A'} (${ipInfo.countryCode || 'N/A'})
▢ *📍 Region:* ${ipInfo.regionName || 'N/A'}
▢ *🏙️ City:* ${ipInfo.city || 'N/A'}
▢ *📮 ZIP Code:* ${ipInfo.zip || 'N/A'}
...
▢ *🛡️ Proxy:* ${ipInfo.proxy ? 'Yes' : 'No'}
▢ *🏢 Hosting:* ${ipInfo.hosting ? 'Yes' : 'No'}
└────────────`;

    await Sarkar.sendMessage(m.chat, { text: txt }, { quoted: m });
...
case 'lyrics': {
  if (!text) return replygcxlicon(`Please provide a song title or lyrics snippet.`);

  const query = text;
  const apiUrl = `https://www.dark-yasiya-api.site/other/lyrics?text=${encodeURIComponent(query)}`;
  ...
  try {
    ...
    if (!res.status) {
      await Sarkar.sendMessage(m.chat, { text: '❌ Unable to fetch lyrics. Please try again later.' }, { quoted: m });
      return;
    }

    const songInfo = res.result;
    let releaseLinks = songInfo.relesed.map(r => `▢ *${r.nama}:* [Link](${r.link})`).join('\n');
    let lyricsText = songInfo.lyric.join('\n');

    let txt = `
┌──「 *SONG LYRICS* 」
▢ *🎵 Artist(s):* ${songInfo.artists || 'N/A'}
...
try {
  ...
  if (!api || api.status !== 200 || !api.result) {
    console.error('API response is invalid or no results found:', api);
    await Sarkar.sendMessage(m.chat, '❌ No results found on Telegram. Please try again with a different username.', { quoted: m });
    return;
  }
  ...
  await Sarkar.sendMessage(m.chat, { text: userInfo }, { quoted: m });
  ...
  await Sarkar.sendMessage(m.chat, { text: '❌ An error occurred while fetching the Telegram data. Please try again later.' }, { quoted: m });
}
}
break;
...
case 'wachannelstalk': {
  ...
  try {
    // API URL for WhatsApp channel data
    ...
    if (!api || api.status !== 200 || !api.success) {
      console.error('API response is invalid or no results found:', api);
      await Sarkar.sendMessage(m.chat, { text: '❌ No results found on WhatsApp Channel. Please try again with a different URL.' }, { quoted: m });
      return;
    }

    // Prepare the channel information message
    ...
    // Send the channel information to the user
    await Sarkar.sendMessage(m.chat, { text: channelInfo }, { quoted: m });
    ...
    await Sarkar.sendMessage(m.chat, { text: '❌ An error occurred while fetching the WhatsApp channel data. Please try again later.' }, { quoted: m });
  }
}
break;
...
🔗 *URL:* ${repoData.html_url}
      `.trim()
      await Sarkar.relayMessage(m.chat, {
...
break
    ...
    // Send to all owners
    for (let i of owner) {
        Sarkar.sendMessage(i + "@s.whatsapp.net", {
            text: textt + teks1,
            mentions: [m.sender],
        }, {
            quoted: m,
...
case 'update': {
    ...
    // Default case - no action, can be used for unknown button types    
            ...
            return {
                ...
                header: proto.Message.InteractiveMessage.Header.fromObject({
                    ...
                    ...(await prepareWAMessageMedia(
                        { image: { url: image } },
                        { upload: Sarkar.waUploadToServer },
                    )),
                }),
                nativeFlowMessage:
        ...
        await Sarkar.relayMessage(jid, msg.message, {
...
case 'truecaller': {
  ...
  if (text) {
    ...
    return await Sarkar.sendText(m.chat, "Please provide a number in international format without +, quote a user, or mention a user.");
  }
  ...
  try {
    ...
    console.error('API Fetch Error:', error);
    return await Sarkar.sendText(m.chat, "An error occurred while fetching the phone details. Please try again.");
  }
}
break;
...
await XliconStickWait()                  
media = await Sarkar.downloadAndSaveMediaMessage(quoted, "volume")
rname = getRandom('.mp3')
exec(`ffmpeg -i ${media} -filter:a volume=${args[0]} ${rname}`, (err, stderr, stdout) => {
fs.unlinkSync(media)
if (err) return replygcxlicon('Error!')
jadie = fs.readFileSync(rname)
Sarkar.sendMessage(m.chat, {audio:jadie, mimetype: 'audio/mp4', ptt: true}, {quoted: m})
fs.unlinkSync(rname)
})
}
break
...
if (err) return replygcxlicon('Error!')
jadie = fs.readFileSync(rname)
Sarkar.sendMessage(m.chat, {video:jadie, mimetype: 'video/mp4'}, {quoted: m})
fs.unlinkSync(rname)
})
}
break
			...
			case 'emojimix': {
                ...
                for (let res of anu.results) {
                    let encmedia = await Sarkar.sendImageAsSticker(m.chat, res.url, m, {
                        packname: global.packname,
			...
			case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'squirrel':
                ...
                if (/audio/.test(mime)) {
                await XliconStickWait()
                let media = await Sarkar.downloadAndSaveMediaMessage(quoted)
                let ran = getRandom('.mp3')
                exec(`ffmpeg -i ${media} ${set} ${ran}`, (err, stderr, stdout) => {
                fs.unlinkSync(media)
                if (err) return replygcxlicon(err)
                let buff = fs.readFileSync(ran)
                Sarkar.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
            ...
            case 'toviewonce': {
                ...
                await XliconStickWait()
                if (/image/.test(mime)) {
                    anuan = await Sarkar.downloadAndSaveMediaMessage(quoted)
                    Sarkar.sendMessage(m.chat, {
                        image: {
                            url: anuan
                        },
                    ...
                    anuanuan = await Sarkar.downloadAndSaveMediaMessage(quoted)
                    Sarkar.sendMessage(m.chat, {
                        video: {
                            url: anuanuan
                        },
                   ...
                   bebasap = await Sarkar.downloadAndSaveMediaMessage(quoted)
                   Sarkar.sendMessage(m.chat, {
                     audio: {
                        url: bebasap
                     },
...
break
			...
			case 'delete': case 'del': case 'd': {
				...
				await Sarkar.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: m.isBotAdmin ? false : true, id: m.quoted.id, participant: m.quoted.sender }})
			}
			break
			case 'linkgroup': case 'linkgrup': case 'linkgc': case 'urlgroup': case 'urlgrup': case 'urlgc': {
				...
				if (!m.isBotAdmin) return XliconStickBotAdmin()
				let response = await Sarkar.groupInviteCode(m.chat)
				await Sarkar.sendMessage(m.chat, { text: `https://chat.whatsapp.com/${response}\n\nLink Group : ${(await Sarkar.groupMetadata(m.chat)).subject}`, detectLink: true }, { quoted: m });
			}
			break
			...
			case 'group': case 'grup': {
				...
				if (!m.isBotAdmin) return XliconStickBotAdmin()
				if (text === 'close') {
					await Sarkar.groupSettingUpdate(m.chat, 'announcement').then((res) => replygcxlicon(`*Successfully Closing The Group*`))
				} else if (text === 'open') {
					await Sarkar.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replygcxlicon(`*Successfully Opening The Group*`))
				} else {
					let button = [{
						name: 'single_select',
						buttonParamsJson: {
					...
					await Sarkar.sendButtonMsg(m.chat, 'Group Mode', xliconytimewisher, 'Please choose', null, button, m);
				}
			}
			break
...
if (!XliconTheCreator) return XliconStickOwner()
    await Sarkar.removeProfilePicture(Sarkar.user.id)
...
for (let i of owner) {
list.push({
	    	displayName: await Sarkar.getName(i),
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await Sarkar.getName(i)}\nFN:${await Sarkar.getName(i)}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:${ytname}\nitem2.X-ABLabel:YouTube\nitem3.URL:${socialm}\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;${location};;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
                Sarkar.sendMessage(m.chat, {
                    contacts: {
			...
			case 'req': case 'request': {
				...
				await Sarkar.sendMessage(m.chat, { text: `*Request Has Been Sent To Owner*\n_Thank You🙏_` }, { quoted: m })
				await Sarkar.sendFromOwner(ownernumber, `Order From : @${m.sender.split('@')[0]}\nFor Owners\n\nRequest ${text}`, m, { contextInfo: { mentionedJid: [m.sender], isForwarded: true }})
			}
			break
...
break;
			...
			case 'inspect': {
				...
				await Sarkar.groupGetInviteInfo(code).then(anu => {
					...
					Sarkar.sendTextMentions(m.chat, par, m);
				}).catch((res) => {
			...
			case 'q': case 'quoted': {
				...
				await Sarkar.relayMessage(m.chat, { [anu.quoted.type]: anu.quoted.msg }, {})
			}
			break
			...
			case 'confes': case 'confess': case 'menfes': case 'menfess': {
				...
				if (!isNaN(teks1) && !teks1.startsWith('0') && teks1) {
					...
					const onWa = await Sarkar.onWhatsApp(tujuan)
					if (!onWa.length > 0) return replygcxlicon('This number is not registered on WhatsApp!')
					...
					game.menfes[tujuan] = {
						...
						nama: 'Recipient',
						waktu: setTimeout(() => {
							if (game.menfes[tujuan]) Sarkar.sendMessage(tujuan, { text: `_Time ${command} finished_` });
							delete game.menfes[tujuan];
						}, 600000)
					};
					Sarkar.sendMessage(tujuan, { text: `_${command} connected_\n*Note :* if you want to end, type _*${prefix}del${command}*_` });
			...
			case 'delconfes': case 'delconfess': case 'delmenfes': case 'delmenfess': {
				...
				Sarkar.sendMessage(anu.tujuan, { text: `Chat Ended By ${anu.nama ? anu.nama : 'Somebody'}` })
			...
			case 'toaud': case 'toaudio': {
				...
				await Sarkar.sendMessage(m.chat, { audio: audio, mimetype: 'audio/mpeg'}, { quoted : m })
			}
			break
			...
			case 'tomp3': {
				...
				let media = await (m.quoted ? m.quoted.download() : m.download())
				let audio = await toAudio(media, 'mp4')
				await Sarkar.sendMessage(m.chat, { document: audio, mimetype: 'audio/mpeg', fileName: `dgxlicon.mp3`}, { quoted : m })
			}
			break
			...
			case 'tovn': case 'toptt': case 'tovoice': {
				...
				await Sarkar.sendMessage(m.chat, { audio: audio, mimetype: 'audio/ogg; codecs=opus', ptt: true }, { quoted: m })
			}
			break
			...
			case 'togif': {
				...
				let media = await Sarkar.downloadAndSaveMediaMessage(qmsg)
				let webpToMp4 = await webp2mp4File(media)
				await Sarkar.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' }, gifPlayback: true }, { quoted: m })
			...
			case 'tovideo': case 'tomp4': {
				...
				let media = await Sarkar.downloadAndSaveMediaMessage(qmsg)
				let webpToMp4 = await webp2mp4File(media)
				await Sarkar.sendMessage(m.chat, { video: { url: webpToMp4.result }, caption: 'Convert Webp To Video' }, { quoted: m })
				await fs.unlinkSync(media)
			}
			break
			...
			case 'toimage': case 'toimg': {
				...
				exec(`ffmpeg -i ${media} ${ran}`, (err) => {
					...
					Sarkar.sendMessage(m.chat, { image: buffer }, { quoted: m })
					fs.unlinkSync(ran)
				})
			}
			break
			...
			case 'toptv': {
				...
				if ((m.quoted ? m.quoted.type : m.type) === 'videoMessage') {
					...
					const msg = await generateWAMessageContent({ video: anu }, { upload: Sarkar.waUploadToServer })
					await Sarkar.relayMessage(m.chat, { ptvMessage: msg.videoMessage }, {})
				} else {
...
break;
			...
			case 'texttospeech-indo': case 'tts-indo': case 'ttsindo': {
				...
				Sarkar.sendMessage(m.chat, { audio: anu, ptt: true, mimetype: 'audio/mpeg' }, { quoted: m })
			}
			break
...
if (!text) return replygcxlicon('Where is the text?')
        ...
        break
			...
			case 'toqr': case 'qr': {
				...
				XliconStickWait()
				await Sarkar.sendMessage(m.chat, { image: { url: 'https://api.qrserver.com/v1/create-qr-code/?size=1000x1000&data=' + text }, caption: 'Here you go!' }, { quoted: m })
			}
			break
			...
			case 'ssweb': {
				...
				if (!text.startsWith('http')) {
					...
					await Sarkar.sendMessage(m.chat, { image: { url: buf }, caption: 'Done' }, { quoted: m })
				} else {
            ...
            //var author = (author  []).join('|')
                let mime = m.quoted.mimetype || ''
                        //let img = await q.download()
                            let img = await Sarkar.downloadAndSaveMediaMessage(quoted, makeid(5))
                                    ...
                                    var stiker = await addExifAvatar(img, `Made by`, `Cheems Bot`)
                                          ...
                                          console.error(e)
                                              if (Buffer.isBuffer(e)) stiker = e
                                                    ...
                                                    if (stiker) Sarkar.sendMessage(m.chat, {
                                                          sticker: stiker
                                                              }, {
                                                                    quoted: m
                                                                        })
...
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await Sarkar.sendImageAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replygcxlicon('Send/Reply Images/Videos/Gifs With Captions ${prefix+command}\nVideo Duration 1-9 Seconds')
let media = await quoted.download()
let encmedia = await Sarkar.sendVideoAsSticker(m.chat, media, m, { packname: global.packname, author: global.author })
} else {
...
Sarkar.downloadAndSaveMediaMessage(quoted, "gifee")
Sarkar.sendMessage(m.chat, {sticker:fs.readFileSync("gifee.webp")}, m, { packname: pcknm, author: atnm })
} else if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await Sarkar.sendImageAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return replygcxlicon('Maximum 10 Seconds!')
let media = await quoted.download()
let encmedia = await Sarkar.sendVideoAsSticker(m.chat, media, m, { packname: pcknm, author: atnm })
} else {
...
mee = await Sarkar.downloadAndSaveMediaMessage(quoted)
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/${encodeURIComponent(atas)}/${encodeURIComponent(bawah)}.png?background=${mem}`
memek = await Sarkar.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
} else {
...
break
			...
			case 'writeleft': {
				...
				.on('exit', () => {
					Sarkar.sendMessage(m.chat, { image: fs.readFileSync('./src/write/images/book/afterleft.jpg'), caption: 'Here you go!' }, { quoted: m })
				})
			}
			break
			...
			case 'writeright': {
				...
				.on('error', () => replygcxlicon(mess.error))
				.on('exit', () => {
					Sarkar.sendMessage(m.chat, { image: fs.readFileSync('./src/write/images/book/afterright.jpg'), caption: 'Here you go!' }, { quoted: m })
				})
			}
			break
			...
			case 'folioleft': {
				...
				.on('error', () => replygcxlicon(mess.error))
				.on('exit', () => {
					Sarkar.sendMessage(m.chat, { image: fs.readFileSync('./src/write/images/folio/afterleft.jpg'), caption: 'Here you go!' }, { quoted: m })
				})
			}
			break
			...
			case 'folioright': {
				...
				.on('error', () => replygcxlicon(mess.error))
				.on('exit', () => {
					Sarkar.sendMessage(m.chat, { image: fs.readFileSync('./src/write/images/folio/afterright.jpg'), caption: 'Here you go!' }, { quoted: m })
				})
			}
			break
...
╭───❍「 *🤖 GREETING* 」
│ ✨ *𝙷𝙴𝙻𝙻𝙾!* 👋
│ 🏷️ *𝙽𝙰𝙼𝙴* : ${m.pushName || 'No Name'}
│ 🎉 *${xliconytimewisher}* 😄
╰───────────❍
${readmore}
╭───❍「 *👤 𝚄𝚂𝙴𝚁 𝙸𝙽𝙵𝙾* 」
│ 🪪 *𝙽𝙰𝙼𝙴* : ${m.pushName || 'No Name'}
│ 📱 *𝙽𝚄𝙼𝙱𝙴𝚁* : +${me.split('@')[0]}
│ 🆔 *𝙸𝙳* : @${m.sender.split('@')[0]}
│ 🌟 *𝚂𝚃𝙰𝚃𝚄𝚂* : ${isVip ? 'VIP' : isPremium ? 'PREMIUM' : 'FREE'}
│ 🎯 *𝙻𝙸𝙼𝙸𝚃* : ${isVip ? 'VIP' : global.db.users[m.sender].limit}
│ 💰 *𝙼𝙾𝙽𝙴𝚈* : ${global.db.users[m.sender]?.uang.toLocaleString('en-IN') || '0'}
╰───────────❍
╭───❍「 *🕒 𝚃𝙸𝙼𝙴 𝙸𝙽𝙵𝙾* 」
│ 📅 *𝙳𝙰𝚃𝙴* : ${xdate}
│ 📆 *𝙳𝙰𝚈* : ${xday}
...
│ 👥 ${prefix}𝚐𝚛𝚘𝚞𝚙𝚖𝚎𝚗𝚞
│ 👑 ${prefix}𝚘𝚠𝚗𝚎𝚛𝚖𝚎𝚗𝚞
│ 🔄 ${prefix}𝚌𝚘𝚗𝚟𝚎𝚛𝚝𝚎𝚛𝚖𝚎𝚗𝚞
│ 📃 ${prefix}𝚕𝚒𝚜𝚝𝚖𝚎𝚗𝚞
│ 🛐 ${prefix}𝚛𝚎𝚕𝚒𝚐𝚒𝚘𝚗𝚖𝚎𝚗𝚞
│ 🎌 ${prefix}𝚊𝚗𝚒𝚖𝚎𝚖𝚎𝚗𝚞
│ 🖼️ ${prefix}𝚛𝚊𝚗𝚍𝚘𝚖𝚙𝚑𝚘𝚝𝚘𝚖𝚎𝚗𝚞
│ 🎥 ${prefix}𝚛𝚊𝚗𝚍𝚘𝚖𝚟𝚒𝚍𝚎𝚘𝚖𝚎𝚗𝚞
│ 🖌️ ${prefix}𝚜𝚝𝚒𝚌𝚔𝚎𝚛𝚖𝚎𝚗𝚞
│ 💾 ${prefix}𝚍𝚊𝚝𝚊𝚋𝚊𝚜𝚎𝚖𝚎𝚗𝚞
│ 🛍️ ${prefix}𝚜𝚝𝚘𝚛𝚎𝚖𝚎𝚗𝚞
│ 🔍 ${prefix}𝚜𝚝𝚊𝚕𝚔𝚎𝚛𝚖𝚎𝚗𝚞
│ ⚙️ ${prefix}𝚘𝚝𝚑𝚎𝚛𝚖𝚎𝚗𝚞
...
if (typemenu === 'v1') {
  Sarkar.sendMessage(m.chat, {
      image: fs.readFileSync('./bandahmedia/theme/SarkarPic.jpg'),
      caption: xmenu_oh
  }, {
      quoted: m
  })
  ...
  Sarkar.sendMessage(m.chat, {
      video: fs.readFileSync('./bandahmedia/theme/Xlicon-Video.mp4'),
      caption: xmenu_oh
  }, {
      quoted: m
  })
...
│${setv} ${prefix}𝚞𝚙𝚍𝚊𝚝𝚎-𝚛𝚎𝚙𝚘 🅞
│${setv} ${prefix}𝚊𝚍𝚍𝚋𝚊𝚍𝚠𝚘𝚛𝚍 🅞
│${setv} ${prefix}𝚍𝚎𝚕𝚋𝚊𝚍𝚠𝚘𝚛𝚍 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚛𝚎𝚊𝚍 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚋𝚒𝚘 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚝𝚢𝚙𝚎 🅞
│${setv} ${prefix}𝚞𝚗𝚊𝚟𝚊𝚒𝚕𝚊𝚋𝚕𝚎 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚛𝚎𝚌𝚘𝚛𝚍 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚛𝚎𝚌𝚘𝚛𝚍𝚝𝚢𝚙𝚎 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚜𝚠𝚟𝚒𝚎𝚠 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚊𝚞𝚝𝚘𝚋𝚕𝚘𝚌𝚔 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚊𝚗𝚝𝚒𝚏𝚘𝚛𝚎𝚒𝚐𝚗 🅞
│${setv} ${prefix}𝚊𝚞𝚝𝚘𝚋𝚕𝚘𝚌𝚔 🅞
│${setv} ${prefix}𝚘𝚗𝚕𝚢𝚐𝚌 🅞
│${setv} ${prefix}𝚘𝚗𝚕𝚢𝚙𝚌 🅞
│${setv} ${prefix}𝚘𝚗𝚕𝚢𝚒𝚗𝚍𝚒𝚊 🅞
│${setv} ${prefix}𝚘𝚗𝚕𝚢𝚒𝚗𝚍𝚘 🅞
│${setv} ${prefix}𝚊𝚗𝚝𝚒𝚌𝚊𝚕𝚕 🅞
│${setv} ${prefix}𝚜𝚎𝚕𝚏 🅞
│${setv} ${prefix}𝚙𝚞𝚋𝚕𝚒𝚌 🅞
│${setv} ${prefix}𝚓𝚘𝚒𝚗 🅞
│${setv} ${prefix}𝚙𝚘𝚕𝚕 🅞
...
│${setv} ${prefix}𝚋𝚌𝚐𝚛𝚘𝚞𝚙 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚖𝚎𝚗𝚞 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚒𝚖𝚐𝚖𝚎𝚗𝚞 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚟𝚒𝚍𝚖𝚎𝚗𝚞 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚐𝚒𝚏𝚖𝚎𝚗𝚞 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚛𝚎𝚙𝚕𝚢 🅞
│${setv} ${prefix}𝚛𝚎𝚜𝚎𝚝𝚑𝚒𝚝 🅞
│${setv} ${prefix}𝚛𝚎𝚜𝚎𝚝𝚞𝚜𝚎𝚛 🅞
│${setv} ${prefix}𝚌𝚛𝚎𝚊𝚝𝚎𝚐𝚌 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚎𝚡𝚒𝚏 🅞
│${setv} ${prefix}𝚐𝚎𝚝𝚎𝚡𝚒𝚏 🅞
│${setv} ${prefix}𝚐𝚎𝚝𝚊𝚞𝚝𝚘𝚋𝚕𝚘𝚌𝚔𝚗𝚞𝚖𝚋𝚎𝚛 🅞
│${setv} ${prefix}𝚐𝚎𝚝𝚊𝚗𝚝𝚒𝚏𝚘𝚛𝚎𝚒𝚐𝚗𝚗𝚞𝚖𝚋𝚎𝚛 🅞
│${setv} ${prefix}𝚞𝚜𝚎𝚛𝚓𝚒𝚍 🅞
│${setv} ${prefix}𝚜𝚎𝚝𝚋𝚘𝚝𝚋𝚒𝚘 🅞
│${setv} ${prefix}𝚍𝚎𝚕𝚙𝚙𝚋𝚘𝚝 🅞
│${setv} ${prefix}𝚜𝚑𝚞𝚝𝚍𝚘𝚠𝚗 🅞
...
│${setv} ${prefix}𝚍𝚎𝚕𝚙𝚍𝚏 🅞
│${setv} ${prefix}𝚍𝚎𝚕𝚟𝚗 🅞
│${setv} ${prefix}𝚊𝚍𝚍𝚜𝚝𝚒𝚌𝚔𝚎𝚛 🅞
│${setv} ${prefix}𝚍𝚎𝚕𝚜𝚝𝚒𝚌𝚔𝚎𝚛 🅞
│${setv} ${prefix}𝚊𝚍𝚍𝚒𝚖𝚊𝚐𝚎 🅞
│${setv} ${prefix}𝚍𝚎𝚕𝚒𝚖𝚊𝚐𝚎 🅞
│${setv} ${prefix}𝚊𝚍𝚍𝚟𝚒𝚍𝚎𝚘 🅞
│${setv} ${prefix}𝚍𝚎𝚕𝚟𝚒𝚍𝚎𝚘 🅞
│${setv} ${prefix}𝚞𝚙𝚜𝚠𝚝𝚎𝚡𝚝 🅞
│${setv} ${prefix}𝚞𝚙𝚜𝚠𝚟𝚒𝚍𝚎𝚘 🅞
│${setv} ${prefix}𝚞𝚙𝚜𝚠𝚒𝚖𝚊𝚐𝚎 🅞
...
│${setv} ${prefix}𝚒𝚙𝚕𝚘𝚘𝚔𝚞𝚙 🅕
│${setv} ${prefix}𝚛𝚎𝚙𝚘𝚜𝚝𝚊𝚕𝚔 🅕
╰─┬────❍
╭─┴❍「 *🤖 OpenAI* 」❍
│${setv} ${prefix}🅕
...
Sarkar.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
}
		}
	} catch (err) {
		console.log(util.format(err))
        let e = String(err)
Sarkar.sendMessage(Sarkar.user.id, { text: "An error occured:" + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
